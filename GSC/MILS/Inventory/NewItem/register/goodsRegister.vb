...
Public Class goodsRegister
    ...
    Sub newLVFormat()
        ' Disable OwnerDraw temporarily
        lvGoodsRegister.OwnerDraw = False

        ' Add columns to the ListView
        With lvGoodsRegister.Columns
            .Add("ENTRY NUMBER", 150)
            .Add("DATE", 150)
            .Add("USER", 150)
            .Add("REMARKS", 156)
            .Add("ENCODED DATE", 150)
        End With

        ' Enable OwnerDraw after adding columns
        lvGoodsRegister.OwnerDraw = True
    End Sub

    Sub loadLV()
        q.loadGoodsRegisterHeader(lvGoodsRegister, tbxEntryId.Text, dtpFrom.Value, dtpTo.Value)
    ...
    Private Sub lvGoodsRegister_DrawColumnHeader(sender As Object, e As DrawListViewColumnHeaderEventArgs) Handles lvGoodsRegister.DrawColumnHeader

    End Sub

    Private Sub lvGoodsRegister_DrawSubItem(sender As Object, e As DrawListViewSubItemEventArgs) Handles lvGoodsRegister.DrawSubItem
        ' Check if it's the first row (index 0) and draw with bold font
