Public Class invViewDetails
    ...
    Sub newLVFormat()
        ...
        With lvProdDes
            .Columns.Add("PRODCUT NUMBER", 125, HorizontalAlignment.Center)
            .Columns.Add("DESCRIPTION", 500)
            .Columns.Add("BATCH CODE", 125, HorizontalAlignment.Center)
            .Columns.Add("LOCATION", 125, HorizontalAlignment.Center)
            .Columns.Add("ON HAND", 125, HorizontalAlignment.Center)
        End With
