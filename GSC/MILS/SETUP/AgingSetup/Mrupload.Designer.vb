...
Partial Class Mrupload
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Note: Import from excel format header will be" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & " ""Pdno"" ,""Des"",""Qty"",""Date"""
        '
        'Button1
        '
